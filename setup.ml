...
(* OASIS_START *)
(* DO NOT EDIT (digest: 487c5db5c591777b470fb33045a53888) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          alpha_features = [];
          beta_features = [];
          name = "ocaml-auth-builder";
          version = "0.0.1";
          license =
            OASISLicense.OtherLicense
              "https://github.com/Jocbe/ocaml-auth-builder/license";
          license_file = None;
          copyrights = [];
          maintainers = ["Johann Beleites <johann@atbel.de>"];
          authors = ["Johann Beleites <johann@atbel.de>"];
          homepage = Some "https://github.com/Jocbe/ocaml-auth-builder";
          synopsis =
            "Advanced authenticator builder for ocaml-tls and ocaml-x509";
          description =
            Some [OASISText.Para "Advanced authenticator builder"];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Abuilder"; "Trust_server"; "Client"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "C\031\195\136G`\130\029\025\003M\150\\\240T~";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
